...
def visdrone_to_coco(
    ...
    for image_filename in tqdm(image_filepath_list):
        ...
        # 去掉了image
        cocoimage_filename = cocoimage_filename[7:]
...
if __name__ == "__main__":
    '''
    fire.Fire(visdrone_to_coco(data_folder_dir = '../dataset/VisDrone2019-DET/VisDrone2019-DET-train/',
                               output_file_path = '../dataset/VisDrone2019-DET/VisDrone2019-DET-train/anno_sahi'))
    '''
    visdrone_to_coco(data_folder_dir = '../dataset/VisDrone2019-DET/VisDrone2019-DET-val/',
                    output_file_path = '../dataset/VisDrone2019-DET/VisDrone2019-DET-val/instances_val2017.json')